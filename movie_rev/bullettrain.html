    ...
    <header class="adoo">
      <div class="slideshow-container">
          ...
          <div class="mySlides fade">
            <img src="../img/coverpics/bullet-train-movie.jpg" class="headimagem">
            <div class="text">
...
<script>
 ...
 window.onclick = function(event) {
    if (event.target == modal) {
      ...
      <div class="mvid">
        <iframe class="mvid1" style="border-radius: 10px;" width="98%" height="315" src="https://www.youtube.com/embed/0IOsk2Vlc4o?si=Qu7U6o2Zcsz4OEXh" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
<footer class="end">
  <div class="footerboxelogo">
    <ul class="footerul">
      <li>CINEBLOG 
       <div><sub><a class="footlink" href="www.lankanblog.lk">by lankanblog.lk</a></sub></div> </li>
    </ul>
  </div>
