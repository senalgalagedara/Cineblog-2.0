    ...
    <header class="adoo">
      <div class="slideshow-container">
          ...
          <div class="mySlides fade">
            <img src="../img/coverpics/ant man1 (2).jpg" class="headimagem">
            <div class="text">
...
<script>
 ...
 window.onclick = function(event) {
    if (event.target == modal) {
      ...
      <div class="mvid">
        <iframe class="mvid1" style="border-radius: 10px;" width="98%" height="315" src="https://www.youtube.com/embed/pWdKf3MneyI?si=FDccY1vPwzfZAC_g" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
