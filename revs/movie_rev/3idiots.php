    ...
    <header class="adoo">
      <div class="slideshow-container">
          ...
          <div class="mySlides fade">
            <img src="../img/coverpics2/3idiots.jpg" class="headimagem">
            <div class="text">
...
<script>
 ...
 window.onclick = function(event) {
    if (event.target == modal) {
      ...
      <div class="mvid">
        <iframe class="mvid1" style="border-radius: 10px;" width="99%" height="315" src="https://www.youtube.com/embed/K0eDlFX9GMc?si=iuFjTf1G85ZStJKA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>  
      </div>
    </div>
